...
_crfs_bhs = (
    ...
    Crf(show_order=30, model='bcpp_subject.communityengagement',
        required=True),
    ...
    Crf(show_order=80, model='bcpp_subject.hivresultdocumentation',
        required=True),
    ...
    Crf(show_order=110, model='bcpp_subject.hivcareadherence', required=True),
    ...
    Crf(show_order=340,
        model='bcpp_subject.positiveparticipant', required=True),
    Crf(show_order=350, model='bcpp_subject.accesstocare', required=False),
