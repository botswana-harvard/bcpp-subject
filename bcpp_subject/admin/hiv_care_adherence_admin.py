...
class HivCareAdherenceAhsT2Admin(SubjectAdminExcludeMixin, CrfModelAdminMixin, admin.ModelAdmin):
    ...
    fields = [
        ...
        'first_regimen',
        'admitted_at_art_start',
        'weeks_months_admitted',
        'hospitalization_reason',
        'hospitalizationevidence_source',
        'hospitalizationevidence_source_other',
    ...
    filter_horizontal = ["regimen_currently_prescribed", "hospitalization_reason"]
    ...
    radio_fields = {
        ...
        "admitted_at_art_start": admin.VERTICAL,
        "weeks_months_admitted": admin.VERTICAL,
        "hospitalizationevidence_source": admin.VERTICAL}
