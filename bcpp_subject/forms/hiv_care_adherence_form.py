...
class HivCareAdherenceFormMixin (SubjectModelFormMixin):
    ...
    def clean(self):
        ...
        if (cleaned_data.get('ever_recommended_arv') == YES and
                cleaned_data.get('ever_taken_arv') == NO and
    ...
    def validate_on_arv(self):
        ...
        if cleaned_data.get('on_arv') == YES:
            if (not cleaned_data.get('clinic_receiving_from') or
        ...
        if cleaned_data.get('on_arv') == YES and not cleaned_data.get('adherence_4_wk'):
            raise forms.ValidationError(
    ...
    def validate_not_on_art(self):
        ...
        if cleaned_data.get('on_arv') == NO:
            ...
            if (cleaned_data.get('ever_taken_arv') == NO and
                    (cleaned_data.get('arv_stop_date') or
                     cleaned_data.get('arv_stop_other') or cleaned_data.get('arv_stop'))):
                raise forms.ValidationError(
