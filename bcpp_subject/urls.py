...
urlpatterns = [
    ...
    url(r'^listboard/(?P<subject_identifier>' + subject_identifier + ')/(?P<survey>' + survey + ')/(?P<page>\d+)/',
        ListBoardView.as_view(), name='listboard_url'),
    url(r'^listboard/(?P<subject_identifier>' + subject_identifier + ')/(?P<survey>' + survey + ')/'
        , ListBoardView.as_view(), name='listboard_url'),
