...
class TestHivRelatedIllnessForm(SubjectMixin, TestCase):
    ...
    def test_valid_form(self):
        form = HivRelatedIllnessForm(data=self.options)
        self.assertTrue(form.is_valid())
        self.assertTrue(form.save())

    def test_if_sti_dx_detected_wasting(self):
        """Asserts that severe weight loss (wasting)
        more than 10% of body weight.
        """
        self.still_illnesses.name = (
    ...
    def test_if_sti_dx_detected_pneumonia_infection(self):
        """Asserts that severe pneumonia or meningitis or
        sepsis during diagnosis.
        """
    ...
    def test_if_sti_dx_detected_herpes_infection(self):
        """Asserts that Herpes infection for more than one month
