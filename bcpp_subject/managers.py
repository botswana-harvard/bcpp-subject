...
class SubjectConsentManager(models.Manager):
    ...
    def get_by_natural_key(
            self, subject_identifier, version, internal_identifier,
            survey_schedule, household_identifier, plot_identifier):
        return self.get(
...
class CorrectConsentManager(models.Manager):
    ...
    def get_by_natural_key(
        ...
        return self.get(
            ...
            version=version,
            **{
                'subject_consent__household_member__internal_identifier':
                internal_identifier,
                'subject_consent__household_member__household_structure__survey_schedule':
                survey_schedule,
                'subject_consent__household_member__household_structure__household_identifier':
                household_identifier,
                'subject_consent__household_member__household_structure'
                '__household__plot__plot_identifier':
                plot_identifier}
        )
