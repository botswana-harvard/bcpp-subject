...
def referral_on_post_save(sender, instance, raw, created, using, **kwargs):
    if not raw:
        try:
            ...
            scheduled_appt_date = referral.scheduled_appt_datetime.date() if referral.scheduled_appt_datetime else referral.scheduled_appt_datetime
            instance.scheduled_appt_date = scheduled_appt_date
            try:
