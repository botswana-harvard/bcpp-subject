...
class OutpatientCare (CrfModelMixin):
    ...
    govt_health_care = models.CharField(
        verbose_name=(
            "In the last 3 months, did you seek care at a Government Primary"
    ...
    dept_care = models.CharField(
        verbose_name=(
            "In the last 3 months, did you seek care at a Hospital Outpatient Department,"
    ...
    prvt_care = models.CharField(
        verbose_name=(
            "In the last 3 months, did you seek care from a Private Doctor? "),
        max_length=17,
        choices=YES_NO_REFUSED,
        help_text="",
    )
    trad_care = models.CharField(
        verbose_name=(
            "In the last 3 months, did you seek care from a Traditional or Faith Healer? "),
        max_length=17,
        choices=YES_NO_REFUSED,
        help_text="",
    )
    care_visits = models.IntegerField(
        verbose_name=(
            "In the last 3 months, how many total outpatient visits have"
    ...
    facility_visited = models.CharField(
        verbose_name=(
            "For the most recent outpatient medical care visit in the past 3 months, which"
    ...
    specific_clinic = models.CharField(
        verbose_name=(
            "For this most recent visit to a Government Primary Health Clinic/Post, "
    ...
    care_reason = models.CharField(
        verbose_name=(
            "For this most recent medical care visit, what was the primary"
            " reason you sought care? "),
        max_length=95,
        choices=CARE_REASON,
        null=True,
        blank=False,
    ...
    outpatient_expense = models.DecimalField(
        ...
        null=True,
        blank=True,
        help_text=("If participant has not paid anything for "
                   "outpatient medical care, please enter 0.00"),
    )
    travel_time = models.CharField(
        verbose_name=("For this most recent outpatient medical care "
                      "visit, how long did it take you to get"
                      " to the clinic? "),
        max_length=25,
    ...
    transport_expense = models.DecimalField(
        verbose_name=(
            "For this most recent outpatient medical care "
            "visit, how much did you have"
            " to pay for transport, food and "
            "accommodation? [include cost for fuel if using"
            " a private car] "),
        max_digits=10,
        decimal_places=2,
        null=True,
    ...
    cost_cover = models.CharField(
        verbose_name=("For this most recent outpatient medical care"
                      " visit, were any of these costs by covered "
    ...
    waiting_hours = models.CharField(
        verbose_name=(
            "For this most recent outpatient medical "
            "care visit, how long did you have"
