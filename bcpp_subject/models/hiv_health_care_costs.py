...
from ..choices import (
    NO_MEDICALCARE_REASON, HEALTH_CARE_PLACE, CARE_REGULARITY, DOCTOR_VISITS)
...
class HivHealthCareCosts(CrfModelMixin):
    ...
    reason_no_care = models.CharField(
        verbose_name=(
            'If you have never received HIV related medical/clinical care, why not?'),
        max_length=115,
    ...
    doctor_visits = models.CharField(
        verbose_name=(
            'In the last 3 months, how often did someone take you to the doctor?'),
        max_length=32,
