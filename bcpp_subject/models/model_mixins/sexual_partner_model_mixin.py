...
from edc_constants.choices import YES_NO_DWTA, YES_NO_UNSURE_DWTA, YES_NO_UNSURE
from edc_constants.constants import OTHER, NOT_APPLICABLE
from edc_map.site_mappers import site_mappers

from ...choices import (
    COMMUNITY_NA, FREQ_IN_YEAR, SEXDAYS_CHOICE, LASTSEX_CHOICE, FIRSTRELATIONSHIP_CHOICE,
    AGE_RANGES, FIRST_DISCLOSE_CHOICE, FIRST_CONDOM_FREQ_CHOICE, FIRST_PARTNER_HIV_CHOICE)
