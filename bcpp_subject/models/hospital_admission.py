...
class HospitalAdmission (CrfModelMixin):
    ...
    reason_hospitalized = models.CharField(
        verbose_name=("What was the primary reason for the most recent "
    ...
    healthcare_expense = models.DecimalField(
        verbose_name=(
            "How much did you have to pay to the healthcare provider"
    ...
    travel_hours = models.CharField(
        verbose_name=("For this most recent hospitalization, "
    ...
    total_expenses = models.DecimalField(
        verbose_name=("For this most recent hospitalization, "
                      "how much did you have to pay for transport,"
                      " food and accommodation, including fuel if "
                      "you used your own car? "),
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
        help_text=("Note:If participant does not want to answer, "
                   "leave blank. Currency is Pula"),
    )
    hospitalization_costs = models.CharField(
        verbose_name=("For this most recent hospitalization, were any of "
                      "these costs by covered by"
