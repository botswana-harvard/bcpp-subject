# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2016-12-21 06:10
from __future__ import unicode_literals

import bcpp_subject.models.subject_consent
import datetime
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('edc_appointment', '0005_auto_20161221_0610'),
        ('member', '__first__'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model.validators.date.datetime_not_future], verbose_name='Report Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model.validators.date.datetime_not_future], verbose_name='Report Date')),
                ('physical_add', django_crypto_fields.fields.encrypted_char_field.EncryptedCharField(blank=True, help_text=' (Encryption: RSA local)', max_length=150, null=True, verbose_name='Description of physical address: ')),
                ('coordinates', models.DecimalField(decimal_places=4, help_text=' Record coordinates of the main gate to the household', max_digits=10, verbose_name='GPS coordinates')),
                ('contact', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='[To the respondent] Can we contact you by telephone?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(default='?', editable=False, max_length=10)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_base.model.validators.date.datetime_not_future], verbose_name='Report Date')),
                ('first_name', django_crypto_fields.fields.encrypted_char_field.EncryptedCharField(blank=True, help_text=' (Encryption: RSA local)', max_length=71, verbose_name='First name or initials ')),
                ('relation', models.CharField(choices=[('spouse', 'spouse'), ('parent', 'parent'), ('sibling', 'sibling'), ('child', 'child'), ('aunt/uncle', 'aunt/uncle'), ('cousin', 'cousin'), ('partner', 'partner/boyfriend/girlfriend'), ('OTHER', 'Other, specify')], max_length=25, verbose_name='Relation')),
                ('relation_other', edc_base.model.fields.custom_fields.OtherCharField(blank=True, editable=True, verbose_name='...if "Other", specify')),
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], max_length=6, verbose_name='Gender')),
                ('age', models.IntegerField(verbose_name='Age')),
                ('present', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Present Today')),
                ('nights_outside', models.IntegerField(verbose_name='Nights spent outside of this Community')),
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_id', edc_base.model.fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('household_member', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='member.HouseholdMember')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offstudy_datetime', models.DateTimeField(validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model.validators.date.datetime_not_future], verbose_name='Off-study Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cancer_record', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No'), ('DWTA', "Don't want to answer")], help_text='Please review the available OPD card or other medical records, for all participants', max_length=25, null=True, verbose_name='Is a record (OPD card, discharge summary) of a cancer diagnosis available to review?')),
                ('tb_record', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No'), ('DWTA', "Don't want to answer")], help_text='Please review the available OPD card or other medical records, for all participants', max_length=25, null=True, verbose_name='Is a record (OPD card, discharge summary, TB card) of a tuberculosis infection available to review?')),
                ('diagnoses', models.ManyToManyField(help_text='tick all that apply', to='bcpp_subject.Diagnoses', verbose_name='Do you recall or is there a record of having any of the following serious illnesses?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_wives', models.IntegerField(blank=True, help_text='Leave blank if participant does not want to respond. (women only)', null=True, verbose_name='WOMEN: How many wives does your husband have (including traditional marriage), including yourself?')),
                ('husband_wives', models.IntegerField(blank=True, help_text='Leave blank if participant does not want to respond. (men only)', null=True, verbose_name='MEN: How many wives do you have, including traditional marriage?')),
                ('ethnic', models.ManyToManyField(help_text='Ask for the original ethnic group', to='bcpp_subject.EthnicGroups', verbose_name='What is your ethnic group?')),
                ('live_with', models.ManyToManyField(help_text='[indicate all that apply]', to='bcpp_subject.LiveWith', verbose_name='Who do you currently live with ?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_partner_cp', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('Not Sure', 'Not Sure')], max_length=25, null=True, verbose_name='To the best of your knowledge, did he/she ever have other sex partners while you two were having a sexual relationship?')),
                ('first_partner_arm', models.CharField(blank=True, max_length=20, null=True)),
                ('first_partner_live', models.ManyToManyField(to='bcpp_subject.PartnerResidency', verbose_name='Over the past 12 months, where has this sexual partner lived to the best of your knowledge?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pregnancy_hiv_tested', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', help_text='Among women who were not known to be HIV-infected prior to the last (or current pregnancy).', max_length=3, verbose_name='Were you tested for HIV during your most recent (or this current) pregnancy?')),
                ('pregnancy_hiv_retested', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], default='N/A', help_text='if the respondent has reached that point by the time of the current interview.', max_length=3, verbose_name='If you tested HIV-negative during the most recent (or this current) pregnancy, were you re-tested for HIV in the last 3 months of your pregnancy or at delivery? ')),
                ('family_planning', models.ManyToManyField(blank=True, help_text='check all that apply', to='bcpp_subject.FamilyPlanning', verbose_name='In the past 12 months, have you used any methods to prevent pregnancy ?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('present', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Present Today')),
                ('nights_outside', models.IntegerField(verbose_name='Nights spent outside of this Community')),
                ('household_composition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bcpp_subject.HouseholdComposition')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('household_member', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='member.HouseholdMember')),
            ],
        ),
        migrations.CreateModel(
            name='SubstanceUse',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_facilities', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('DWTA', "Don't want to answer")], max_length=35, null=True, verbose_name='Were you aware that circumcision services are provided free of charge at most health facilities?')),
                ('aware_free', models.CharField(blank=True, choices=[('Radio', 'Radio'), ('Television', 'Television'), ('Friend told me', 'Friend told me'), ('Family told me', 'Family told me'), ('Health worker told me', 'Health worker told me'), ('Kgosi told us', 'Kgosi told us'), ('I heard it at the kgotla', 'I heard it at the kgotla'), ('I read a brochure delivered to my home', 'I read a brochure delivered to my home'), ('I read it in the newspaper', 'I read it in the newspaper'), ('Heard it at a community event', 'Heard it at a community event'), ('not_sure', 'I am not sure'), ('DWTA', "Don't want to answer")], max_length=85, null=True, verbose_name='Where did you learn that circumcision services were available free at most health facilities?')),
                ('health_benefits_smc', models.ManyToManyField(blank=True, to='bcpp_subject.CircumcisionBenefits', verbose_name='What do you believe are the health benefits of male circumcision? (Indicate all that apply.)')),
                ('subject_visit', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bcpp_subject.SubjectVisit')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SubjectConsent',
            fields=[
                ('surveymodelmixin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='bcpp_subject.SurveyModelMixin')),
                ('created', models.DateTimeField(default=edc_base.utils.get_utcnow, editable=False)),
                ('modified', models.DateTimeField(default=edc_base.utils.get_utcnow, editable=False)),
                ('user_created', edc_base.model.fields.userfield.UserField(blank=True, editable=False, max_length=50, verbose_name='user created')),
                ('user_modified', edc_base.model.fields.userfield.UserField(blank=True, editable=False, max_length=50, verbose_name='user modified')),
            ...
            bases=(bcpp_subject.models.subject_consent.SubjectIdentifierMixin, 'bcpp_subject.surveymodelmixin', django_crypto_fields.mixins.CryptoMixin, models.Model),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='sti',
            name='sti_dx',
            field=models.ManyToManyField(help_text='(tick all that apply)', to='bcpp_subject.StiIllnesses', verbose_name='[Interviewer:] Indicate each potentially HIV-related illness that is reported by the participant and/or recorded in his or her medical records'),
        ),
        migrations.AddField(
            model_name='sti',
            name='subject_visit',
        ...
        migrations.AddField(
            ...
            name='religion',
            field=models.ManyToManyField(to='bcpp_subject.Religion', verbose_name='What is your religion affiliation?'),
        ),
        migrations.AddField(
            model_name='rbddemographics',
            name='subject_visit',
        ...
        migrations.AddField(
            ...
            name='surveymodelmixin_ptr',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='bcpp_subject.SurveyModelMixin'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='bcpp_subject.HouseholdComposition'),
        ),
        migrations.AddField(
            model_name='historicalrespondent',
            name='subject_visit',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(help_text='(tick all that apply)', to='bcpp_subject.HeartDisease', verbose_name='[Interviewer:] What is the heart disease or stroke diagnosis as recorded?'),
        ),
        migrations.AddField(
            model_name='heartattack',
            name='subject_visit',
        ...
        migrations.AddField(
            ...
            name='ethnic',
            field=models.ManyToManyField(help_text='Ask for the original ethnic group', to='bcpp_subject.EthnicGroups', verbose_name='What is your ethnic group?'),
        ),
        migrations.AddField(
            model_name='demographics',
            name='live_with',
            field=models.ManyToManyField(help_text='[indicate all that apply]', to='bcpp_subject.LiveWith', verbose_name='Who do you currently live with ?'),
        ),
        migrations.AddField(
            model_name='demographics',
            name='religion',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(help_text='Note:Interviewer to read question but NOT the responses. Check the boxes of any of problems mentioned.', to='bcpp_subject.NeighbourhoodProblems', verbose_name='What are the major problems in this neighbourhood??'),
        ),
        migrations.AddField(
            model_name='communityengagement',
            name='subject_visit',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='bcpp_subject.CircumcisionBenefits', verbose_name='What do you believe are the health benefits of male circumcision? (Indicate all that apply.)'),
        ),
        migrations.AddField(
            model_name='circumcision',
            name='subject_visit',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='bcpp_subject.MedicalCareAccess', verbose_name='In the past year, where else have you obtained medical care or treatment when you or someone in your family is sick or hurt? (check all that apply)'),
        ),
        migrations.AddField(
            model_name='accesstocare',
            name='subject_visit',
