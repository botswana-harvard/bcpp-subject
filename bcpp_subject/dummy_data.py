...
from bcpp_subject.models.list_models import Diagnoses, CircumcisionBenefits
...
class TestDummyData:
    ...
    def subject_visit(self, gender, omang):
        ...
        dob = (report_datetime - relativedelta(years=household_member.age_in_years)).date()
        mommy.make_recipe(
    ...
    def smc_unk(self, subject_visit):
        ...
        health_benefits_smc = CircumcisionBenefits.objects.get(name='Improved hygiene')
