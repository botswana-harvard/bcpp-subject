...
class TestDemographicsForm(SubjectMixin, TestCase):
    ...
    def test_marriage_gender_female_valid(self):
        """ Assert that if a participant is married and with number
        of wife less than 1 validation error thrown.
        """
    ...
    def test_marriage_gender_female_none_valid(self):
        """ Assert that if a participant is married and with number
        of wife not provided validation error thrown.
        """
    ...
    def test_marriage_gender_female_husband_valid(self):
        """ Assert that a female participant is married and with
        husband_wives provided validation error thrown.
        """
    ...
    def test_live_with_alone_valid(self):
        """ Assert that the many to many Alone can not be
    ...
    def test_live_with_don_not_want_to_answer_valid(self):
        """ Assert that the many to many Don\'t want to answer
        can not be selected with another value.
        """
        livewith2 = mommy.make_recipe('bcpp_subject.livewith',
    ...
    def test_1_ethic_group_at_a_time(self):
        """ Assert that a participant can only be in 1 ethnic group.
        """
    ...
    def test_marital_status_wives(self):
        """Assert that if married and the participant is male the
        number of wife has to be greater than 1.
        """
    ...
    def test_marital_status_husbands(self):
        """Assert that if married and the participant is male the
        number of wives has to be greater than 1.
        """
        self.data.update(marital_status=MARRIED,
                         husband_wives=0,
                         subject_visit=self.subject_visit_male.id)
