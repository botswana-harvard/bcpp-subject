...
#     def test_if_self.when_circ and not self.age_unit_circ:
#         """Test If participant answered age of circumcision then you must provide time units"""
#     def_if_not_circ and age_unit_circ:
